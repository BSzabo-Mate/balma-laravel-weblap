...
php
Kód másolása
├── app/              # Laravel backend kód (Controllers)
├── bootstrap/
├── config/
├── database/         # Migrations
├── public/           # Minden nyilvános adat (képek, css)
├── resources/        # Blade view-k, JS, (tailwind CSS, de ezt nem használtam, egyszerüsített inline css)
├── routes/           # A weboldal utvonalainak kezelése
├── storage/
├── tests/
└── composer.json
